ayats = [
    ...
    {
        "verse_number": "40",
        "arabic_text": "إِنَّآ أَنذَرْنَٰكُمْ عَذَابٗا قَرِيبٗاۖ يَوْمَ يَنظُرُ ٱلْمَرْءُ مَا قَدَّمَتْ يَدَـٰهُ وَيَقُولُ ٱلْكَـٰفِرُ يَٰلَيْتَنِي كُنتُ تُرَٰبٗا",
