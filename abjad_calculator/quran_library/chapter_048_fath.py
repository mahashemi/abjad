...
Arabic: الفتح
Total Verses: 29
Generated: 2026-01-13T00:01:48.349604
"""

ayats = [
  {
    "verse_number": 1,
    "english_text": "Verily, We have given you a clear victory.",
    "arabic_text": "اِنَّا فَتَحْنَا لَكَ فَتْحًۭا مُّبِينًۭا",
    "urdu_text": "بیشک ہم نے آپ کو کھلی فتح عطا فرمائی۔",
    "persian_text": "به راستی که ما برای تو پیروزی آشکاری عطا کردیم.",
  ...
  },
  {
    ...
    "arabic_text": "لِّيَغْفِرَ لَكَ اللَّهُ مَا تَقَدَّمَ مِن ذَنۢبِكَ وَ مَا تَاَخَّرَ وَيُتِمَّ نِعْمَتَهُ عَلَيْكَ وَيَهْدِيَكَ صِرَٰطًۭا مُّسْتَقِيمًۭا",
  ...
  {
    "verse_number": 3,
    "english_text": "And help you in a magnificent way.",
    "arabic_text": "وَيَنصُرَكَ اللَّهُ نَصْرًا عَزِيزًا",
    "urdu_text": "اور اللہ آپ کی زبردست مدد فرمائے۔",
    "persian_text": "و خداوند تو را یاری عزیز و شکوهمندی عطا کند.",
    "transliteration": "Wa yansurakал-laahu nasran 'azeezaa"
  },
  {
    "verse_number": 4,
    ...
    "arabic_text": "هُوَ الَّذِىٓ اَنزَلَ السَّكِينَةَ فِى قُلُوبِ الْمُؤْمِنِينَ لِيَزْدَادُوٓاْ اِيمَـٰنًۭا مَّعَ اِيمَـٰنِهِمْ ۗ وَلِلَّهِ جُنُودُ السَّمَـٰوَٰتِ وَالْاَرْضِ ۚ وَكَانَ اللَّهُ عَلِيمًا حَكِيمًۭا",
  ...
  {
    "verse_number": 5,
    "english_text": "That He may cause believing men and believing women to enter into Paradise beneath which rivers are flowing that they always abide in it and shall remove their evil from them, this is the grand success near Allah.",
    "arabic_text": "لِّيُدْخِلَ الْمُؤْمِنِينَ وَالْمُؤْمِنَـٰتِ جَنَّـٰتٍۢ تَجْرِى مِن تَحْتِهَا الْاَنْهَـٰرُ خَـٰلِدِينَ فِيهَا وَيُكَفِّرَ عَنْهُمْ سَيِّـَٔاتِهِمْ ۚ وَكَانَ ذَٰلِكَ عِندَ اللَّهِ فَوْزًا عَظِيمًۭا",
    "urdu_text": "تاکہ مومن مردوں اور مومن عورتوں کو ایسے باغات میں داخل فرمائے جن کے نیچے نہریں بہتی ہیں، وہ ان میں ہمیشہ رہیں گے، اور ان کی برائیاں ان سے دور فرما دے، اور یہ اللہ کے نزدیک بہت بڑی کامیابی ہے۔",
    "persian_text": "تا مردان و زنان مؤمن را به باغ‌هایی وارد کند که از زیر آن نهرها جاری است، جاودانه در آن بمانند و بدی‌های آنان را بپوشاند، و این نزد خداوند رستگاری بزرگی است.",
    "transliteration": "Li-yudkhilal-mu'mineena wal-mu'minaati jannaatin tajree min tahtihaal-anhaaru khaalideena feehaa wa yukaffira 'anhum sayyi-aatihim wa kaana dhaalika 'indal-laahi fawzan 'azheemaa"
  },
  {
    "verse_number": 6,
    ...
    "arabic_text": "وَيُعَذِّبَ الْمُنَـٰفِقِينَ وَالْمُنَـٰفِقَـٰتِ وَالْمُشْرِكِينَ وَالْمُشْرِكَـٰتِ الظَّآنِّينَ بِاللَّهِ ظَنَّ السَّوْءِ ۚ عَلَيْهِمْ دَآئِرَةُ السَّوْءِ ۖ وَغَضِبَ اللَّهُ عَلَيْهِمْ وَلَعَنَهُمْ وَاَعَدَّ لَهُمْ جَهَنَّمَ ۖ وَسَآءَتْ مَصِيرًۭا",
  ...
  },
  {
    ...
    "arabic_text": "وَلِلَّهِ جُنُودُ السَّمَـٰوَٰتِ وَالْاَرْضِ ۚ وَكَانَ اللَّهُ عَزِيزًا حَكِيمًا",
  ...
  },
  {
    ...
    "arabic_text": "اِنَّآ اَرْسَلْنَـٰكَ شَـٰهِدًۭا وَمُبَشِّرًۭا وَنَذِيرًۭا",
  ...
  {
    "verse_number": 9,
    "english_text": "So that you may believe in Allah and His Prophet and help and respect him; and glorify Allah morning and evening.",
    "arabic_text": "لِّتُؤْمِنُواْ بِاللَّهِ وَرَسُولِهِ وَتُعَزِّرُوهُ وَتُوَقِّرُوهُ وَتُسَبِّحُوهُ بُكْرَةًۭ وَاَصِيلًا",
    "urdu_text": "تاکہ تم اللہ اور اس کے رسول پر ایمان لاؤ اور ان کی مدد کرو اور ان کی تعظیم کرو، اور صبح و شام اللہ کی تسبیح کرو۔",
    "persian_text": "تا به خدا و پیامبرش ایمان آورید و او را یاری کنید و احترام نهید و خدا را صبح و شام تسبیح گویید.",
    "transliteration": "Li-tu'minoo bil-laahi wa rasoolihee wa tu'azziroohu wa tuwaqqiroohu wa tusabbihoohu bukratan wa aseelaa"
  },
  {
    "verse_number": 10,
    "english_text": "Verily those pay allegiance to you in fact they pay allegiance to Allah, and Allah's Hand is upon their hands, and now whoever breaks the allegiance, he acts against himself; and whoever will fulfil the Divine Promise, Allah will shortly bestow upon him the grand reward.",
    "arabic_text": "اِنَّ الَّذِينَ يُبَايِعُونَكَ اِنَّمَا يُبَايِعُونَ اللَّهَ يَدُ اللَّهِ فَوْقَ اَيْدِيهِمْ ۚ فَمَن نَّكَثَ فَاِنَّمَا يَنكُثُ عَلَىٰ نَفْسِهِ ۖ وَمَنْ اَوْفَىٰ بِمَا عَـٰهَدَ عَلَيْهُ اللَّهَ فَسَيُؤْتِيهِ اَجْرًا عَظِيمًۭا",
    "urdu_text": "بیشک جو لوگ آپ سے بیعت کرتے ہیں وہ دراصل اللہ سے بیعت کرتے ہیں، اللہ کا ہاتھ ان کے ہاتھوں پر ہے، پھر جو کوئی بیعت توڑے گا تو وہ اپنے ہی خلاف توڑے گا، اور جو اللہ سے کیے ہوئے عہد کو پورا کرے گا تو اللہ عنقریب اسے بہت بڑا اجر عطا فرمائے گا۔",
    "persian_text": "کسانی که با تو بیعت می‌کنند در حقیقت با خدا بیعت می‌کنند، دست خدا بالای دست‌های آنان است، پس هر که پیمان بشکند تنها به زیان خود شکسته و هر که به آنچه با خدا عهد بسته وفا کند، خداوند به زودی پاداش بزرگی به او خواهد داد.",
    "transliteration": "Innal-ladheena yubayi'oonaka innamaa yubayi'oonal-laaha yadul-laahi fawqa aydeehim faman-nakatha fa-innamaa yankuthu 'alaa nafsihee wa man awfaa bimaa 'aahada 'alayhil-laaha fa-sayu'teehi ajran 'azheemaa"
  },
  {
    "verse_number": 11,
    ...
    "arabic_text": "سَيَقُولُ لَكَ الْمُخَلَّفُونَ مِنَ الْاَعْرَابِ شَغَلَتْنَآ اَمْوَٰلُنَا وَاَهْلُونَا فَاسْتَغْفِرْ لَنَا ۚ يَقُولُونَ بِاَلْسِنَتِهِم مَّا لَيْسَ فِى قُلُوبِهِمْ ۚ قُلْ فَمَن يَمْلِكُ لَكُم مِّنَ اللَّهِ شَيْـًٔا اِنْ اَرَادَ بِكُمْ ضَرًّا اَوْ اَرَادَ بِكُمْ نَفْعًۢا ۚ بَلْ كَانَ اللَّهُ بِمَا تَعْمَلُونَ خَبِيرًۢا",
  ...
  },
  {
    ...
    "arabic_text": "بَلْ ظَنَنتُمْ اَن لَّن يَنقَلِبَ الرَّسُولُ وَالْمُؤْمِنُونَ اِلَىٰٓ اَهْلِيهِمْ اَبَدًۭا وَزُيِّنَ ذَٰلِكَ فِى قُلُوبِكُمْ وَظَنَنتُمْ ظَنَّ السَّوْءِ وَكُنتُمْ قَوْمًۢا بُورًۭا",
  ...
  },
  {
    ...
    "arabic_text": "وَمَن لَّمْ يُؤْمِنۢ بِاللَّهِ وَرَسُولِهِ فَاِنَّآ اَعْتَدْنَا لِلْكَـٰفِرِينَ سَعِيرًۭا",
  ...
  },
  {
    ...
    "arabic_text": "وَلِلَّهِ مُلْكُ السَّمَـٰوَٰتِ وَالْاَرْضِ ۚ يَغْفِرُ لِمَن يَشَآءُ وَيُعَذِّبُ مَن يَشَآءُ ۚ وَكَانَ اللَّهُ غَفُورًۭا رَّحِيمًۭا",
  ...
  },
  {
    ...
    "arabic_text": "سَيَقُولُ الْمُخَلَّفُونَ اِذَا انطَلَقْتُمْ اِلَىٰ مَغَانِمَ لِتَاْخُذُوهَا ذَرُونَا نَتَّبِعْكُمْ ۖ يُرِيدُونَ اَن يُبَدِّلُواْ كَلَـٰمَ اللَّهِ ۚ قُل لَّن تَتَّبِعُونَا كَذَٰلِكُمْ قَالَ اللَّهُ مِن قَبْلُ ۖ فَسَيَقُولُونَ بَلْ تَحْسُدُونَنَا ۚ بَلْ كَانُواْ لَا يَفْقَهُونَ اِلَّا قَلِيلًۭا",
  ...
  },
  {
    ...
    "arabic_text": "قُل لِّلْمُخَلَّفِينَ مِنَ الْاَعْرَابِ سَتُدْعَوْنَ اِلَىٰ قَوْمٍ اُو۟لِى بَاْسٍۢ شَدِيدٍۢ تُقَـٰتِلُونَهُمْ اَوْ يُسْلِمُونَ ۖ فَاِن تُطِيعُواْ يُؤْتِكُمُ اللَّهُ اَجْرًا حَسَنًۭا ۖ وَاِن تَتَوَلَّوْاْ كَمَا تَوَلَّيْتُم مِّن قَبْلُ يُعَذِّبْكُمْ عَذَابًا اَلِيمًۭا",
  ...
  },
  {
    ...
    "arabic_text": "لَّيْسَ عَلَى الْاَعْمَىٰ حَرَجٌۭ وَلَا عَلَى الْاَعْرَجِ حَرَجٌۭ وَلَا عَلَى الْمَرِيضِ حَرَجٌۭ ۗ وَمَن يُطِعِ اللَّهَ وَرَسُولَهُ يُدْخِلْهُ جَنَّـٰتٍۢ تَجْرِى مِن تَحْتِهَا الْاَنْهَـٰرُ ۖ وَمَن يَتَوَلَّ يُعَذِّبْهُ عَذَابًا اَلِيمًۭا",
  ...
  },
  {
    ...
    "arabic_text": "۞ لَّقَدْ رَضِىَ اللَّهُ عَنِ الْمُؤْمِنِينَ اِذْ يُبَايِعُونَكَ تَحْتَ الشَّجَرَةِ فَعَلِمَ مَا فِى قُلُوبِهِمْ فَاَنزَلَ السَّكِينَةَ عَلَيْهِمْ وَاَثَـٰبَهُمْ فَتْحًۭا قَرِيبًۭا",
  ...
  {
    "verse_number": 19,
    "english_text": "And gave many benefits which they will receive, Allah is Predominant on everyone and Wise.",
    "arabic_text": "وَمَغَانِمَ كَثِيرَةًۭ يَاْخُذُونَهَا ۗ وَكَانَ اللَّهُ عَزِيزًا حَكِيمًۭا",
    "urdu_text": "اور بہت سے فوائد عطا کیے جو وہ حاصل کریں گے، اور اللہ غالب اور حکمت والا ہے۔",
    "persian_text": "و غنایم بسیاری که آن‌ها را خواهند گرفت، و اللہ توانا و حکیم است.",
    "transliteration": "Wa maghanima katheeratan ya'khudhoona-ha wa kaanallahu 'azeezan hakeema"
  },
  {
    "verse_number": 20,
    ...
    "arabic_text": "وَعَدَكُمُ اللَّهُ مَغَانِمَ كَثِيرَةًۭ تَاْخُذُونَهَا فَعَجَّلَ لَكُمْ هَـٰذِهِ وَكَفَّ اَيْدِىَ النَّاسِ عَنكُمْ وَلِتَكُونَ ءَايَةًۭ لِّلْمُؤْمِنِينَ وَيَهْدِيَكُمْ صِرَٰطًۭا مُّسْتَقِيمًۭا",
  ...
  },
  {
    ...
    "arabic_text": "وَاُخْرَىٰ لَمْ تَقْدِرُواْ عَلَيْهَا قَدْ اَحَاطَ اللَّهُ بِهَا ۚ وَكَانَ اللَّهُ عَلَىٰ كُلِّ شَىْءٍۢ قَدِيرًۭا",
  ...
  },
  {
    ...
    "arabic_text": "وَ لَوْ قَـٰتَلَكُمُ الَّذِينَ كَفَرُواْ لَوَلَّوُاْ الْاَدْبَـٰرَ ثُمَّ لَا يَجِدُونَ وَلِيًّۭا وَلَا نَصِيرًۭا",
  ...
  {
    "verse_number": 23,
    "english_text": "This is a tradition of Allah which has passed, and you can never find a change in the method of Allah.",
    "arabic_text": "سُنَّةَ اللَّهِ الَّتِى قَدْ خَلَتْ مِن قَبْلُ ۖ وَلَن تَجِدَ لِسُنَّةِ اللَّهِ تَبْدِيلًۭا",
    "urdu_text": "یہ اللہ کی سنت ہے جو پہلے سے چلی آ رہی ہے، اور تم اللہ کی سنت میں کبھی تبدیلی نہیں پاؤ گے۔",
    "persian_text": "این سنت خداوند است که از پیش گذشته، و هرگز در سنت خداوند تغییری نخواهی یافت.",
    "transliteration": "Sunnata Allaahi allatee qad khalat min qabl, wa lan tajida li sunnati Allaahi tabdeelaa"
  },
  {
    "verse_number": 24,
    ...
    "arabic_text": "وَهُوَ الَّذِى كَفَّ اَيْدِيَهُمْ عَنكُمْ وَاَيْدِيَكُمْ عَنْهُم بِبَطْنِ مَكَّةَ مِنۢ بَعْدِ اَنْ اَظْفَرَكُمْ عَلَيْهِمْ ۚ وَكَانَ اللَّهُ بِمَا تَعْمَلُونَ بَصِيرًا",
  ...
  {
    "verse_number": 25,
    "english_text": "These are the people who adopted infidelity and barred you from entering the Sacred Mosque, and barred the animals of sacrifice from reaching their destinations, and if believing men and believing women were not there whom you didn't know and there was fear of unknowingly trampling upon them, and in this way you may have unintentionally incurred the loss which would not have been stopped, it was stopped because with whomever Allah pleases causes him to enter into His Mercy; if they would have been separated, We would have encompassed infidels into the painful punishment.",
    "arabic_text": "هُمُ الَّذِينَ كَفَرُواْ وَصَدُّوكُمْ عَنِ الْمَسْجِدِ الْحَرَامِ وَالْهَدْىَ مَعْكُوفًا اَن يَبْلُغَ مَحِلَّهُ ۚ وَلَوْلَا رِجَالٌۭ مُّؤْمِنُونَ وَنِسَآءٌۭ مُّؤْمِنَـٰتٌۭ لَّمْ تَعْلَمُوهُمْ اَن تَطَـُٔوهُمْ فَتُصِيبَكُم مِّنْهُم مَّعَرَّةٌۢ بِغَيْرِ عِلْمٍۢ ۖ لِّيُدْخِلَ اللَّهُ فِى رَحْمَتِهِ مَن يَشَآءُ ۚ لَوْ تَزَيَّلُواْ لَعَذَّبْنَا الَّذِينَ كَفَرُواْ مِنْهُمْ عَذَابًا اَلِيمًا",
    "urdu_text": "یہ وہی لوگ ہیں جنہوں نے کفر اختیار کیا اور تمہیں مسجد حرام سے روکا اور قربانی کے جانوروں کو بھی روک دیا کہ وہ اپنی جگہ تک پہنچیں، اور اگر وہاں مومن مرد اور مومن عورتیں نہ ہوتیں جنہیں تم نہیں جانتے تھے کہ تم انہیں روند ڈالو اور تمہیں ان کی وجہ سے نادانستہ نقصان پہنچے، تاکہ اللہ جسے چاہے اپنی رحمت میں داخل کرے، اگر وہ الگ ہو جاتے تو ہم ان میں سے کافروں کو دردناک عذاب دیتے۔",
    "persian_text": "آنان کسانی هستند که کفر ورزیدند و شما را از مسجد الحرام باز داشتند و قربانیها را از رسیدن به محل خود بازداشتند، و اگر مردان و زنان مؤمنی نبودند که آنان را نمی‌شناختید و بیم آن بود که ناخواسته آنان را لگدمال کنید و بدین سبب بی‌آنکه بدانید به شما آسیبی برسد، تا خداوند هر که را بخواهد در رحمت خود داخل کند، اگر آنان جدا می‌شدند، کافران را به عذابی دردناک گرفتار می‌ساختیم.",
    "transliteration": "Humu alladheena kafaroo wa saddookum 'ani al-masjidi al-haraami wa al-hadya ma'koofan an yablugha mahillah, wa law laa rijaalum mu'minoona wa nisaa'um mu'minaatun lam ta'lamoohum an tata'oohum fa tuseebakum minhum ma'arratun bi-ghayri 'ilm, li-yudkhila Allaahu fee rahmatihee man yashaa', law tazayyaloo la'adhdhab-na alladheena kafaroo minhum 'adhaaban aleemaa"
  },
  {
    "verse_number": 26,
    "english_text": "This is of that time when infidels who harboured in their hearts the feelings of disdain of the days of ignorance (that they will not allow you to enter Makkah), so Allah sent down tranquility on the Prophet and the people of faith and kept them steady on piety, and they were deserving of this, and Allah is Knower of everything.",
    "arabic_text": "اِذْ جَعَلَ الَّذِينَ كَفَرُواْ فِى قُلُوبِهِمُ الْحَمِيَّةَ حَمِيَّةَ الْجَـٰهِلِيَّةِ فَاَنزَلَ اللَّهُ سَكِينَتَهُ عَلَىٰ رَسُولِهِ وَعَلَى الْمُؤْمِنِينَ وَاَلْزَمَهُمْ كَلِمَةَ التَّقْوَىٰ وَكَانُوٓاْ اَحَقَّ بِهَا وَاَهْلَهَا ۚ وَكَانَ اللَّهُ بِكُلِّ شَىْءٍ عَلِيمًۭا",
    "urdu_text": "جب کافروں نے اپنے دلوں میں جاہلیت کی ضد اور تعصب رکھا، تو اللہ نے اپنے رسول اور مومنوں پر سکینت نازل فرمائی اور انہیں تقویٰ کی بات پر قائم رکھا، اور وہ اس کے زیادہ حقدار اور اہل تھے، اور اللہ ہر چیز کا جاننے والا ہے۔",
    "persian_text": "آنگاه که کافران در دلهای خود تعصب جاهلیت را قرار دادند، خداوند آرامش خود را بر پیامبرش و بر مؤمنان نازل کرد و آنان را به کلمه تقوا پایبند ساخت، و آنان سزاوارتر و شایسته‌تر آن بودند، و خداوند به هر چیزی داناست.",
    "transliteration": "Idh ja'ala alladheena kafaroo fee quloobihimu al-hamiyyata hamiyyata al-jaahiliyyati fa-anzala Allaahu sakeenatahu 'alaa rasoolihee wa 'alaa al-mu'mineena wa alzamahum kalimata at-taqwaa wa kaanoo ahaqqa bihaa wa ahlahaa, wa kaana Allaahu bi-kulli shay'in 'aleemaa"
  },
  {
    "verse_number": 27,
    ...
    "arabic_text": "لَّقَدْ صَدَقَ اللَّهُ رَسُولَهُ الرُّءْيَا بِالْحَقِّ ۖ لَتَدْخُلُنَّ الْمَسْجِدَ الْحَرَامَ اِن شَآءَ اللَّهُ ءَامِنِينَ مُحَلِّقِينَ رُءُوسَكُمْ وَمُقَصِّرِينَ لَا تَخَافُونَ ۖ فَعَلِمَ مَا لَمْ تَعْلَمُواْ فَجَعَلَ مِن دُونِ ذَٰلِكَ فَتْحًۭا قَرِيبًا",
  ...
  {
    "verse_number": 28,
    "english_text": "That is Allah Who sent His Prophet with the guidance and the true religion that it dominates all the (previous) religions; and Allah is sufficient for a Witness.",
    "arabic_text": "هُوَ الَّذِىٓ اَرْسَلَ رَسُولَهُ بِالْهُدَىٰ وَدِينِ الْحَقِّ لِيُظْهِرَهُ عَلَى الدِّينِ كُلِّهِ ۚ وَكَفَىٰ بِاللَّهِ شَهِيدًۭا",
    "urdu_text": "وہی ہے جس نے اپنے رسول کو ہدایت اور دین حق کے ساتھ بھیجا تاکہ اسے تمام ادیان پر غالب کر دے، اور اللہ گواہ کے طور پر کافی ہے۔",
    "persian_text": "او کسی است که پیامبرش را با هدایت و دین حق فرستاد تا آن را بر همه ادیان چیره گرداند، و خداوند به عنوان گواه کافی است.",
    "transliteration": "Huwa alladhee arsala rasoolahu bil-hudaa wa deeni al-haqqi li-yudhhirahu 'alaa ad-deeni kullih, wa kafaa bi-Allaahi shaheedaa"
  },
  {
    "verse_number": 29,
    ...
    "arabic_text": "مُّحَمَّدٌۭ رَّسُولُ اللَّهِ ۚ وَالَّذِينَ مَعَهُٓ اَشِدَّآءُ عَلَى الْكُفَّارِ رُحَمَآءُ بَيْنَهُمْ ۖ تَرَىٰهُمْ رُكَّعًۭا سُجَّدًۭا يَبْتَغُونَ فَضْلًۭا مِّنَ اللَّهِ وَرِضْوَٰنًۭا ۖ سِيمَاهُمْ فِى وُجُوهِهِم مِّنْ اَثَرِ السُّجُودِ ۚ ذَٰلِكَ مَثَلُهُمْ فِى التَّوْرَىٰةِ ۚ وَمَثَلُهُمْ فِى الْاِنجِيلِ كَزَرْعٍ اَخْرَجَ شَطْـَٔهُ فَـَٔازَرَهُ فَاسْتَغْلَظَ فَاسْتَوَىٰ عَلَىٰ سُوقِهِ يُعْجِبُ الزُّرَّاعَ لِيَغِيظَ بِهِمُ الْكُفَّارَ ۗ وَعَدَ اللَّهُ الَّذِينَ ءَامَنُواْ وَعَمِلُواْ الصَّـٰلِحَـٰتِ مِنْهُم مَّغْفِرَةًۭ وَاَجْرًا عَظِيمًۢا",
